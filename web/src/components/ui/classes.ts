...
export const headerIconButtonClass = `inline-flex h-header-icon w-header-icon shrink-0 items-center justify-center rounded-ui border border-ink ${pressableClass}`;
